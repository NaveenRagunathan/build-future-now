    ...
    <section id="contact" className="py-20 bg-gradient-to-b from-black to-zinc-900">
      <div className="container mx-auto px-4 md:px-6">
        <div className="text-center mb-16">
          <h2 className="text-3xl md:text-4xl font-bold mb-6 text-white">Ready to Build Your Future?</h2>
        ...
        <div className="max-w-3xl mx-auto">
          <div className="bg-black/70 backdrop-blur-sm border border-gray-800 rounded-xl p-6 md:p-8">
            <form onSubmit={handleSubmit} className="space-y-6">
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                <div className="space-y-2">
                  ...
                  <Input
                    ...
                    required
                    className="bg-zinc-900 border-gray-700 focus:border-saas-yellow text-gray-100"
                    value={formData.name}
              ...
              <div className="space-y-2">
                <Label htmlFor="painPoints" className="text-gray-200">What challenges are you facing with your current website? (optional)</Label>
                <Textarea
                  id="painPoints"
                  name="painPoints"
                  placeholder="Share your current challenges or goals..."
                  className="bg-zinc-900 border-gray-700 focus:border-saas-yellow min-h-[120px] text-gray-100"
        ...
        <div className="mt-16 text-center">
          <h3 className="text-xl font-semibold mb-2 text-white">Or reach us directly</h3>
